...
export default function ResizableRightPanel({ showParticipants, onToggleParticipants, isCollapsed, onToggleCollapse }: ResizableRightPanelProps) {
  ...
  if (isCollapsed) {
    return (
      <aside className="fixed right-0 top-14 bottom-0 w-12 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 shadow-xl z-30 flex flex-col items-center py-4">
        <button
  ...
  return (
    <aside 
      className="fixed right-0 top-14 bottom-0 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 shadow-xl z-30 flex flex-col transition-all duration-300"
      style={{ width: `${width}px` }}
    >
      {/* Collapse Button */}
      <button
        onClick={onToggleCollapse}
        className="absolute -left-12 top-4 p-2 bg-white dark:bg-gray-900 border-l border-t border-b border-gray-200 dark:border-gray-800 rounded-l-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shadow-lg"
      ...
      >
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-12 bg-gray-300 dark:bg-gray-700 group-hover:bg-blue-500 rounded-full transition-colors"></div>
      </div>
